...
\; \mbox{ quand } \, x \to x_0,
$$ et de plus, pour tout $\varepsilon > 0$, si
$x \in [\max(0, x_0-\varepsilon), x_0+\varepsilon]$, alors $$
\left|\frac{e^{-x(1+t^2)}}{1+t^2}\right| 
\leq 
\frac{e^{-\max(0, x_0-\varepsilon)(1+t^2)}}{1+t^2}
$$ Le second membre de cette équation étant intégrable (il est positif
et décroit quand $t\to +\infty$ plus vite que $1/t^2$), par [le théorème
...
changement de variable $x=\sqrt{t}$, puis $z = g(u)$, `\begin{align*}
\int_{\varepsilon}^{\varepsilon^{-1}} F'(x) \, dx
...
[^6]: A tel point que s'il l'on peut prouver l'existence d'une fonction
