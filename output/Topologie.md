...
n'appartiennent pas à $D$. Donc toute boule ouverte $B((0,x_2), r)$ est
...
$f^{-1}(-1) = (\sqrt{2}/2, \sqrt{2}/2)$ et $f^{-1}(\infty) = (1,0)$,
donc $d^{\pm \infty}(0, +\infty) = d((0,1), (1,0)) = \sqrt{2},$
...
$\varepsilon > 0$. Or cet intervalle contient des irrationels, qui
...
\end{array}
\right.
$$ Cette fonction est minimale sur $A$ pour $(x, y) = (-1, -1)$. On a
donc $$
...
calculé comme la limite de la suite $x_{k+1} = B \cdot x_k$ pour un
...
$$ L'application $\Phi$ est donc contractante si $\|A\| \leq 1/T$. [Le
théorème du point fixe de Banach (p.
...
$\alpha > \|A\| T$. Pour tout $T > 0$, [le théorème du point fixe de
