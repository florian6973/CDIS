...
```\addcontentsline{toc}{subsubsection}{A propos du terme ``intégrable''}```{=latex}
...
$(x_0, y_0)$ d'arête de longueur $(\ell_1/2 + \ell_2) \varepsilon$.
([Solution p.
...
$$ Quand à la première fonction, d'après les questions qui précèdent,
...
[^4]: Peut-être que dans le contexte ou l'on exploite l'expression, les
